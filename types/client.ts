...
import * as ClientEngine_export from './types/ClientEngine';
import * as KeyboardControls_export from './types/controls/KeyboardControls';
import * as Renderer_export from './types/render/Renderer';
import * as AFrameRenderer_export from './types/render/AFrameRenderer';
...
declare const ClientEngine_default: typeof ClientEngine_export.default;
declare const KeyboardControls_default: typeof KeyboardControls_export.default;
declare const Renderer_default: typeof Renderer_export.default;
declare const AFrameRenderer_default: typeof AFrameRenderer_export.default;
...
export {
  ...
  Lib_default as Lib,
  ClientEngine_default as ClientEngine,
  KeyboardControls_default as KeyboardControls,
  Renderer_default as Renderer,
  AFrameRenderer_default as AFrameRenderer,
};
...
declare namespace LanceTypes {
  ...
  const ClientEngine: typeof ClientEngine_export;
  const KeyboardControls: typeof KeyboardControls_export;
  const Renderer: typeof Renderer_export;
  const AFrameRenderer: typeof AFrameRenderer_export;
}